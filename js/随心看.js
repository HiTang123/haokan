...
globalThis.bili_cookie='SESSDATA=7624af93%2C1696008331%2C862c8%2A42;bili_jct=141a474ef3ce8cf2fedf384e68f6625d;DedeUserID=3493271303096985;DedeUserID__ckMd5=212a836c164605b7';
...
var rule = {
    ...
    lazy:$js.toString(() => {
        if(input.includes('>>')&&input.split('>>')[1].split('<<')[0]!=''){
            ...
            let i=input.split('+');
            input={url:'http://127.0.0.1:9978/proxy?do=bili&aid='+i[1]+'&cid='+i[2]+'&qn=32&type=mpd',header:{'Referer':'https://www.bilibili.com','cookie':'buvid3=84B0395D-C9F2-C490-E92E-A09AB48FE26E71636infoc','User-Agent' : 'Mozilla/5.0 (X11; Linux aarch64) AppleWebKit/537.36(KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36'}}
        }else{
            input
        }
    }),
