!function(e, t) {
    ...
    return function(e) {
        ...
        o.keys()
            .forEach(e => {
            if ("./index.js" !== e) for (var t in o(e)) n[t] = o(e)[t]
        }), e.exports = n
    }, function(e, t, r) {
        var n = {
            "./array/array.js": 2,
        ...
        e.exports = {
            arrayUniq: function(e) {
                for (var t = [], r = 0, n = e.length; r < n; r++)("," + t + ",")
                    .indexOf("," + e[r] + ",") < 0 && t.push(e[r]);
                return t
            }
        }
    }, function(e, t) {
        var r = {
            getBrowserInfo: function() {
                ...
                for (t = [
                    ...
                    ["IE", /msie[ ](\d+\.\d+)/],
                    ["Safari", /safari\/([\d\.]+)/]
                ], e = 0; e < t.length; e++) if (r = o.match(t[e][1])) {
        ...
        var n = {
            ...
            getDayType: function(e, t) {
                var r = e.split("-"),
                    ...
                    a = parseInt(o[0]),
                    s = "";
                return i >= 0 && a <= 12 && (s = "上午"), i >= 12 && a <= 18 && (s = "下午"), i >= 18 && a <= 24 && (s = "晚间"), t && i >= 11 && a <= 13 && (s = "中午"), s
            },
            getTimeInterval: function(e, t) {
                var r = [0, 0, 0, 0],
                    n = "",
                    o = t > e ? parseInt((t - e) / 1e3) : 0;
                return r[0] = o > 86400 ? parseInt(o / 86400) : 0, o -= 86400 * r[0], r[1] = o > 3600 ? parseInt(o / 3600) : 0, o -= 3600 * r[1], r[2] = o > 60 ? parseInt(o / 60) : 0, r[3] = o - 60 * r[2], n = r[0] > 0 ? r[0] + "天" : "", n += r[0] <= 0 && r[1] <= 0 ? "" : r[1] + "小时", n += r[0] <= 0 && r[1] <= 0 && r[2] <= 0 ? "" : r[2] + "分钟", n += r[0] <= 0 && r[1] <= 0 && r[2] <= 0 && r[3] <= 0 ? "" : r[3] + "秒"
            },
        ...
        var r = {
            ...
            getOperator: function(e, t) {
                var r = e || "",
                    n = r.substring(0, 3),
                    o = r.substring(0, 4),
                    i = !! /^1\d{10}$/.test(r) && ("130,131,132,155,156,185,186,145,176".indexOf(n) >= 0 ? "联通" : "133,153,180,181,189,177,173,170".indexOf(n) >= 0 ? "电信" : "1349" == o ? "电信" : "134,135,136,137,138,139,150,151,152,157,158,159,187,188,147,182,183,184,178".indexOf(n) >= 0 ? "移动" : "未知");
        ...
        var r = {
            ...
            setQuery: function(e, t) {
                var r = t ? t.match(/#.*/) && t.match(/#.*/)[0] || "" : location.hash,
                    n = t ? t.replace(/#.*/, "")
                        .match(/\?.*/) && t.replace(/#.*/, "")
                        .match(/\?.*/)[0] || "" : location.search,
                    o = t ? t.replace(/#.*/, "")
                        .replace(/\?.*/, "") : location.protocol + "//" + location.host + location.pathname;
                for (var i in e) {
                    var a = i + "=" + e[i],
                        s = getQuery(i, n);
                    n = s ? n.replace(i + "=" + s, i + "=" + e[i]) : n.length > 0 ? n + "&" + a : "?" + a
                }
                return o + n + r
            },
            ...
            replaceParam: function(e, t, r, n) {
                r = r || location.href;
                var o = new RegExp("([\\?&]" + e + "=)[^&#]*");
                return r.match(o) ? n ? r.replace(o, "$1" + t) : r : -1 == r.indexOf("?") ? r + "?" + e + "=" + t : r + "&" + e + "=" + t
            },
            loadCss: function(e) {
        ...
        var r = {
            checkUserId: function(e) {
                ...
                if (r = t.substring(6, 10), n = t.substring(10, 12), o = t.substring(12, 14), 0 == /[1-9]\d{3}\-(0[1-9]|1[0-2])\-([0-2]\d|3[0-1])/.test(r + "-" + n + "-" + o)) return "身份证生日无效。";
                if ((new Date)
                    .getFullYear() - r > 150 || (new Date)
                    .getTime() - new Date(r, n - 1, o)
                    .getTime() < 0) return "身份证生日不在有效范围";
                ...
                return t += i[u % 11], 18 != e.length ? "" : t != e.toLowerCase() ? "不是合法的身份证号码" : ""
            }
        };
        e.exports = r
    }])
