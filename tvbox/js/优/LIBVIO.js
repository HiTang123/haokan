...
var rule = {
	...
	host:'https://www.libvio.link',
	//hostJs:'print(HOST);let html=request(HOST,{headers:{"User-Agent":MOBILE_UA}});let src=pdfa(html,"body&&a:has(i)")[0];print(src);HOST=pdfh(src,"a&&href")',
